...
if __name__ == '__main__':
    ...
    np.savetxt('ValidationLoss_Cutout.txt', resnet_history.history['val_loss'])
    np.savetxt('ValidationAccuracy_Cutout.txt', resnet_history.history['val_accuracy'])
    np.savetxt('TrainingLoss_Cutout.txt', resnet_history.history['loss'])
    np.savetxt('TrainingAccuracy_Cutout.txt', resnet_history.history['accuracy'])
    np.savetxt('TestResult_Cutout.txt', np.array([test_loss,test_accuracy,another_test_loss,another_test_accuracy]))