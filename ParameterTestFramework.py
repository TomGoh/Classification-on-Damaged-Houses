...
if __name__ == '__main__':
    ...
    para_dir2 = {'rotation_range': 0.15, 'width_shift_range': 0, 'height_shift_range': 0, 'zoom_range': 0}
    ...
    for i, j in zip(para_dir, range(1, 5)):
        ...
        train_data, vali_data, test_data, another_test_data = build_data_generator(dataset_path='archive/', para_list=i,
        ...
        np.savetxt('history/TestResult_Generator'+str(j)+'.txt',np.array([test_loss, test_accuracy, another_test_loss, another_test_accuracy]))
