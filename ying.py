...
def main():
    ...
    train_damaged,placeholder=load_folder_data('archive/train_another/damaged',damaged=True)
    train_no_damaged, placeholder = load_folder_data('archive/train_another/no_damage', damaged=True)

    test_damaged, placeholder = load_folder_data('archive/test/damaged', damaged=True)
    test_no_damaged, placeholder = load_folder_data('archive/test/no_damage', damaged=True)

    test_another_damaged, placeholder = load_folder_data('archive/test_another/damaged', damaged=True)
    test_another_no_damaged, placeholder = load_folder_data('archive/test_another/no_damage', damaged=True)

    vali_damaged, placeholder = load_folder_data('archive/validation_another/damaged', damaged=True)
    vali_no_damaged, placeholder = load_folder_data('archive/validation_another/no_damage', damaged=True)

    for i, j in zip(train_damaged,list(range(train_damaged.shape[0]))):
        image=Ying_2017_CAIP(i)
